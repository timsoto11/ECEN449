//////////////////////////////////////////////////////////////////////////////
// Filename:          /homes/ugrad/billlipeng/ECEN449/lab4/drivers/multiply_v1_00_a/src/multiply_selftest.c
// Version:           1.00.a
// Description:       Contains a diagnostic self-test function for the multiply driver
// Date:              Wed Nov 13 23:28:31 2013 (by Create and Import Peripheral Wizard)
//////////////////////////////////////////////////////////////////////////////
...
XStatus MULTIPLY_SelfTest(void * baseaddr_p)
{
  ...
  MULTIPLY_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = MULTIPLY_mReadSlaveReg0(baseaddr, 0);
  ...
  MULTIPLY_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = MULTIPLY_mReadSlaveReg1(baseaddr, 0);
  ...
  MULTIPLY_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = MULTIPLY_mReadSlaveReg2(baseaddr, 0);
